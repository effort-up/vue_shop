<template>
  <div>
      ...
      <el-table :data='orderList' style="width: 100%" border stripe>
        ...
        <el-table-column label='操作'>
          <template >
            ...
            <el-button type="success" icon="el-icon-location-outline" size='mini' @click="progress"></el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
    ...
    <!-- 修改地址信息对话框 -->
    <el-dialog title="修改地址" :visible.sync="AddressDialogVisible" width="50%" @close='addressFormClose'>
...
export default {
  ...
  methods: {
    ...
    async progress() {
      ...
      if(res.meta.status != 200) this.$message.error('物流信息获取失败！')
      console.log(res)
